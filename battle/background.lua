...
--- @class bt.Background
bt.Background = meta.abstract_class("BattleBackground", rt.Widget)
...
--- @class bt.ShaderOnlyBackground
bt.ShaderOnlyBackground = meta.class("ShaderOnlyBackground", bt.Background)

--- @brief
function bt.ShaderOnlyBackground(path, disabled_elapsed, enable_compression)
    meta.install(self, {
        _path = path,
        _shader = {},   -- rt.Shader
