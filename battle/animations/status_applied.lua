rt.settings.battle.animations.status_applied = {
    duration = 2
}

--- @class bt.Animation.STATUS_APPLIED
bt.Animation.STATUS_APPLIED = meta.new_type("STATUS_APPLIED", bt.Animation, function(scene, target, status)
...
function bt.Animation.STATUS_APPLIED:update(delta)
    ...
    local duration = rt.settings.battle.animations.status_applied.duration
