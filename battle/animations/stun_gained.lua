...
bt.Animation.STUN_GAINED = meta.class("STUN_GAINED", rt.Animation)

--- @brief
function bt.Animation.STUN_GAINED:instantiate(scene, entity, message)
...
meta.install(bt.Animation.STUN_GAINED, {
    _path = nil, -- rt.Spline
    _duration = 1, -- seconds
    _n_shakes = 2,
