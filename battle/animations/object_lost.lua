...
bt.Animation.OBJECT_LOST = meta.class("OBJECT_LOST", rt.Animation)

--- @brief
function bt.Animation.OBJECT_LOST:instantiate(scene, object, entity, message)
...
meta.install(bt.Animation.OBJECT_LOST, {
    object_to_sprite = {},
