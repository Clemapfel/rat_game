...
bt.Animation.ENEMY_APPEARED = meta.class("ENEMY_APPEARED", rt.Animation)

--- @brief
function bt.Animation.ENEMY_APPEARED:instantiate(scene, entity, message)
...
bt.Animation.ENEMY_APPEARED_shader = (function()
