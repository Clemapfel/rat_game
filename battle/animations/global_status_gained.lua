...
--- @class bt.Animation
bt.Animation.GLOBAL_STATUS_GAINED = meta.class("GLOBAL_STATUS_GAINED", rt.Animation)

function bt.Animation.GLOBAL_STATUS_GAINED:instantiate(scene, status, message)
