...
bt.Animation.OBJECT_GAINED = meta.new_type("OBJECT_GAINED", rt.Animation)

--- @brief
function bt.Animation.OBJECT_GAINED:instantiate(scene, object, entity, message)
...
bt.Animation.OBJECT_GAINED.object_to_sprite = {}
