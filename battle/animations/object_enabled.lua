...
bt.Animation.OBJECT_ENABLED = meta.new_type("OBJECT_ENABLED", rt.Animation)

--- @brief
function bt.Animation.OBJECT_ENABLED:instantiate(scene, object, entity, message)
...
bt.Animation.OBJECT_ENABLED._cache = {} -- store shards if caching enabled
