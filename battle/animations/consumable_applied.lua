...
bt.Animation.CONSUMABLE_APPLIED = meta.class("CONSUMABLE_APPLIED", rt.Animation)

--- @brief
function bt.Animation.CONSUMABLE_APPLIED:instantiate(scene, slot_i, entity, message)
