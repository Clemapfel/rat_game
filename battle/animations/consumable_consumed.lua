...
bt.Animation.CONSUMABLE_CONSUMED = meta.class("CONSUMABLE_CONSUMED", rt.Animation)

--- @brief
function bt.Animation.CONSUMABLE_CONSUMED:instantiate(scene, consumable, entity, message)
...
bt.Animation.CONSUMABLE_CONSUMED.consumable_to_sprite = {}
