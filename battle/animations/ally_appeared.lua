...
bt.Animation.ALLY_APPEARED = meta.class("ALLY_APPEARED", rt.Animation)

function bt.Animation.ALLY_APPEARED(scene, entity, message)
...
bt.Animation.ALLY_APPEARED._shader = (function()
