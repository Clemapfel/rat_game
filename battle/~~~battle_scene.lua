...
bt.SceneState = meta.new_enum("BattleSceneState", {
    INSPECT = "inspect",
...
function bt.BattleScene:draw()
    ...
    if self._scene_state == bt.SceneState.INSPECT and self._text_box:get_reveal_indicator_visible() then
    ...
    elseif self._scene_state == bt.SceneState.MOVE_SELECTION then
...
--- @brief
function bt.BattleScene:_start_move_selection() -- TODO
...
function bt.BattleScene:_handle_button_pressed(which)
    ...
    if self._scene_state == bt.SceneState.INSPECT then
