return {
    ...
    on_knocked_out = function(self, holder, knock_out_causer)
        ...
        println("[DBG] In " .. self.id .. ".on_knocked_out: " .. holder.id .. " was knocked out by " .. knock_out_causer.id)
        return nil
    end,
    ...
    on_helped_up = function(self, holder, help_up_causer)
        ...
        println("[DBG] In " .. self.id .. ".on_helped_up: " .. holder.id .. " was helped up by " .. help_up_causer.id)
        return nil
    end,
    ...
    on_killed = function(self, holder, death_causer)
        ...
        println("[DBG] In " .. self.id .. ".on_killed: " .. holder.id .. " was killed up by " .. death_causer.id)
        return nil
    end,
