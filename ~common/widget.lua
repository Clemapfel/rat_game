...
rt.Orientation = meta.enum("Orientation", {
    HORIZONTAL = "HORIZONTAL",
    VERTICAL = "VERTICAL"
})

rt.Alignment = meta.enum("Alignment", {
    START = "START",
    CENTER = "CENTER",
    END = "END"
})
...
--- @class rt.Widget
rt.Widget = meta.abstract_class("Widget", rt.Drawable)
...
function rt.Widget:fit_into(aabb, y, w, h)
    ...
    if w == nil then w = POSITIVE_INFINITY end
    if h == nil then h = POSITIVE_INFINITY end
