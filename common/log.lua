...
--- @brief print non-critical log message
--- @param ... string no prefix space, no postfix newline
...
--- @brief print terminating error message
--- @param ... string no prefix space, no postfix newline
function log.error(...)
    local to_print = {}
...
--- @brief set hook to intercept log messages and errors, for example to write them to a file
--- @param hook function (string) -> boolean
