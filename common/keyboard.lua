...
rt.Keyboard = meta.class("Keyboard", rt.Widget)

--- @brief
function rt.Keyboard:instantiate(max_n_entry_chars, suggestion)
...
function rt.Keyboard:size_allocate(x, y, width, height)
    ...
    if self._snapshot_texture ~= nil then
        self._snapshot_texture:free()
    end
