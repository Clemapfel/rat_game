...
rt.VertexShape = meta.class("VertexShape", rt.Drawable)

--- @brief
function rt.VertexShape:instantiate(data, draw_mode, format)
    meta.install(self, {
...
rt.VertexRectangle = function(x, y, width, height)
    ...
    local out = setmetatable({}, meta.get_instance_metatable(rt.VertexShape))
