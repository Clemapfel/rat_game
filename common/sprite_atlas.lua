...
rt.SpriteAtlasEntry = meta.class("SpriteAtlasEntry")

--- @brief
function rt.SpriteAtlasEntry:instantiate(path, id)
    meta.install(self, {
        id = id,
        path = path,
        texture = {},  -- rt.Texture
...
rt.SpriteAtlas = meta.class("SpriteAtlas")

--- @brief
function rt.SpriteAtlas:instantiate()
    meta.install(self, {
        _folder = "",
