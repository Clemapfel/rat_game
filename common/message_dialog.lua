...
rt.MessageDialogOption = meta.enum("MessageDialogOption", {
    ACCEPT = "OK",
    CANCEL = "Cancel"
})
...
rt.MessageDialog = meta.class("MessageDialog", rt.Widget)

function rt.MessageDialog:instantiate(message, submessage, option1, ...)
    ...
    meta.assert_string(self._message)
    meta.assert_string(self._submessage)
