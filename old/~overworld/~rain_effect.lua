...
--- @class RainEffect
--- @param n_snowflakes Number of instances
rt.RainEffect = meta.new_type("RainEffect", function(n_snowflakes)

    local out = meta.new(rt.RainEffect, {
        _n_snowflakes = n_snowflakes,
        _data = love.graphics.newMesh(
                n_snowflakes, rt.MeshDrawMode.POINTS, rt.SpriteBatchUsage.STATIC
        ),
        _shape = love.graphics.newMesh(
                {{0, 0}}, rt.MeshDrawMode.POINTS, rt.SpriteBatchUsage.STATIC
        ),
