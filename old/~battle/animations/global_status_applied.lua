...
bt.Animation.GLOBAL_STATUS_APPLIED = meta.new_type("GLOBAL_STATUS_APPLIED", bt.Animation, function(scene, target, status)
...
function bt.Animation.GLOBAL_STATUS_APPLIED:start()
    self._label = rt.Label("<o>Global Applied: <b><mono>" .. self._status:get_name() .. "</mono></b></o>")
    self._label:realize()
    self._label_path = {}
