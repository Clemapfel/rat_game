...
bt.Animation.GLOBAL_STATUS_GAINED = meta.new_type("GLOBAL_STATUS_GAINED", bt.Animation, function(scene, target, status)
...
function bt.Animation.GLOBAL_STATUS_GAINED:start()
    self._label = rt.Label("<o>Global Gained: <b><mono>" .. self._status:get_name() .. "</mono></b></o>")
    self._label:realize()
    self._label_path = {}
