...
spritesheet = rt.Spritesheet("assets/sprites", "entity_portrait")
sprite = rt.Sprite(spritesheet, "test")
sprite:set_margin(100)

flip_shader_elapsed = 0
flip_shader = rt.Shader("assets/shaders/texture_flip.glsl")
...
love.update = function()
    ...
    -- tODO
    flip_shader_elapsed = flip_shader_elapsed + delta
    flip_shader:send("_time", flip_shader_elapsed)
    local aabb = sprite._texture_aabb
    --flip_shader:send("_texture_rect", {aabb.x, aabb.y, aabb.width, aabb.height})
end
